                    ...
                    <div class="row">
                        <div class="col-12 align-items-start bg-dark vh-100">
                            <div class="row g-1 text-center">
                                ...
                                <div class="col-12 mt-5" style="cursor:pointer ;" onclick="window.location='sellingHistory.php';">
                                    <hr class="border border-1 border-white" />
                                    ...
                                    <div class="row g-1">
                                        <div class="col-12 bg-primary text-white text-center rounded" style="height: 100px;">
                                            ...
                                            for ($x = 0; $x < $invoice_num; $x++) {
                                                ...
                                                $splitMonth = explode("-", $pdate); //separatedate as year,month, and date
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            ...
                            <?php
                                if ($freq_num > 0) {
                                    ...
                                    `user_email1`='" . $product_data["user_email"] . "'");
