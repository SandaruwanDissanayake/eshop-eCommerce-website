    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 pt-3" style="background-color:#E3E5E5 ;">
                        ...
                        ?>
                            ...
                            <div class="col-12 ">
                                ...
                                <div class="offset-lg-4 col-12 col-lg-4 d-grid">
                                    <a href="home.php" class="btn btn-outline-danger fs-3 fw-bold mb-3">Added</a>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 col-lg-9 ">
                                        <div class="row">
                                            ...
                                            for ($x = 0; $x < $cart_num; $x++) {
                                                ...
                                                $address_rs = Database::search("SELECT distric.id AS did FROM `user_has_address` INNER JOIN `city` ON 
                                                user_has_address.city_id=city.id INNER JOIN `distric` ON city.distric_id=distric.id WHERE
                                                `user_email`='" . $email . "'");
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="card-body">
                                                                ...
                                                                <input type="number" class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext" value="<?php echo $product_data["qty"]; ?>">
                                                                <br><br>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                <span class="fs-6 fw-bold">Rs. <?php echo $shiping ?> .00</span>
                                            </div>
                                            ...
                                            <div class="col-6 mt-2 text-end">
                                                <span class="fs-4 fw-bold">Rs. <?php echo($total+$shiping); ?> .00</span>
                                            </div>
        ...
        <?php
                        ...
                        echo ("Pleace sign in or register");
                    }
