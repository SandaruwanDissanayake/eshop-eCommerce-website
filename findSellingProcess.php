...
?>
                <div class="row">
                    ...
                    <div class="col-2 bg-white d-grid">
                        ...
                        ?>
                            <button class="btn btn-primary fw-bold  mt-1 mb-1" onclick="changeStatus('<?php echo $invoice_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Shiping</button>
                        <?php

                        } else if ($invoice_data["status"] == 4) {
                        ?>
                            <button class="btn btn-danger fw-bold  mt-1 mb-1" onclick="changeStatus('<?php echo $invoice_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Delivery</button>
                        <?php
