    ...
    <div class="container-fluid justify-content-center" style="margin-top:100px ;">
        <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 d-block">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control" placeholder="Ex : Jhone@gmail.com" id="e">
                            </div>
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn btn-danger" onclick="backToHome();">Back To Customer Log In</button>
            ...
            <div class="col-12 fixed-bottom text-center">
                <p>&copy; 2022 eSop.lk | All Right Reserverd</p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="verify();">Verfy</button>
                    </div>
                </div>
            </div>
        </div>
