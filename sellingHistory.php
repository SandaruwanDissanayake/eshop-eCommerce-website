...
<body style="background-color: #74EBD5;background-image: linear-gradient(90deg,#74EBD5 0%,#9FACE6 100%);">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light mt-3 mb-3">
                <div class="row">
                    <div class="col-12 col-lg-3 mt-3 mb-3">
                        ...
                        <input type="text" class="form-control fs-5" id="serchTxt" onkeyup="searchInvoiceId();" />
                    </div>
                    ...
                    <div class="row">
                        ...
                        if($selected_data["status"]==0){
                            ...
                            <button class="btn btn-primary fw-bold  mt-1 mb-1"  onclick="changeStatus('<?php echo $selected_data['id']; ?>');"
                             id="btn<?php echo $selected_data["id"]; ?>">Shiping</button>
                            <?php
                            ...
                            <button class="btn btn-danger fw-bold  mt-1 mb-1"  onclick="changeStatus('<?php echo $selected_data['id']; ?>');"
                             id="btn<?php echo $selected_data["id"]; ?>">Delivery</button>
                            <?php
            ...
            <!--  -->
            <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3 mt-3 " id="pageination">
